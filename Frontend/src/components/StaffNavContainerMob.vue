...
const resetStoreData = (staff_role: string) => {
  ...
  else if (staff_role === 'head') {
    userAuthStore.headData = {
      academicYears: [],
      departments: [],
      heads: null,
      classes: [],
...
<template>
    <div class="nav-container-drawer" v-show="elementsStore.navDrawer">
        ...
        <!-- Admin -->
        <v-list class="nav-list-container" v-if="userAuthStore.userData['staff_role'].toLowerCase() === 'administrator'">
        ...
        <!-- Head -->
        <v-list class="nav-list-container" v-if="headRoles.includes(userAuthStore.userData?.['staff_role']?.toLowerCase())">
          ...
          <v-list-item @click="changePage('HeadStaff')" class="nav-item nav-link" prepend-icon="mdi-account-group">
            STAFF
          </v-list-item>

          <v-list-item v-if="userAuthStore.userData['current_role']['level']['has_departments']" @click="changePage('HeadDepartments')" class="nav-item nav-link" prepend-icon="mdi-office-building">
            DEPARTMENTS
          </v-list-item>

          <v-list-item class="nav-item nav-link" prepend-icon="mdi-calendar-clock" @click="changePage('HeadAcademicYears')">
            ACADEMIC YEARS
          </v-list-item>
          ...
          <v-list-group>
            ...
            <v-list-item class="nav-title nav-link" v-for="(_class, index) in userAuthStore.headData.classes"
              :key="`${_class['name']}${index}`"
              @click="changePage(`HeadStudentsClass,${_class['name']},${index}`)">
              {{ _class['name'] }}
            </v-list-item>
          </v-list-group>
        ...
        <!-- Teacher -->
        <v-list class="nav-list-container" v-if="userAuthStore.userData['staff_role'].toLowerCase() === 'teacher'">
