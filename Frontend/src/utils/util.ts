...
export const headRoles:string[] = ['headmaster', 'headmistress', 'assistant head mistress', 'assistant headmaster', 'head of academics', 'assistant head of academics', 'principal']
