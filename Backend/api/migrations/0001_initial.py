# Generated by Django 5.0 on 2024-05-02 11:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.FileField(upload_to='F:\\PRO\\Git_Repository\\school-management-system\\Backend\\staticfiles\\files')),
            ],
        ),
        migrations.CreateModel(
            name='School',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_contact', models.CharField(blank=True, default='not set', max_length=15, null=True, verbose_name='Alternate Phone No')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_contact', models.CharField(blank=True, default='not set', max_length=15, null=True, verbose_name='Alternate Phone No')),
                ('address', models.CharField(default='not set', max_length=100, verbose_name='Address')),
                ('religion', models.CharField(default='not set', max_length=50, verbose_name='Religion')),
                ('pob', models.CharField(default='not set', max_length=50, verbose_name='Home City/Town')),
                ('region', models.CharField(default='not set', max_length=50, verbose_name='Region')),
                ('nationality', models.CharField(default='GHANAIAN', max_length=50, verbose_name='Nationality')),
                ('guardian', models.CharField(default='not set', max_length=100, verbose_name='Guardian Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students_year', models.IntegerField(blank=True, null=True, verbose_name='Students Year')),
                ('date', models.DateField(default=datetime.date(2024, 5, 2), verbose_name='Attendance Date')),
